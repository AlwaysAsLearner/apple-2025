...
const Showcase = () => {
  const isTablet = useMediaQuery({ query: "(max-window: 1024px )"}) 
            ...
            <div className='wrapper'>
                <div className='lg:max-w-md'>
                    ...
                    <div className='space-y-5 mt-7 pe-10' >
                        ...
                        <p className='text-[#0071e3]'>Learn more about Apple Intelligence</p>
                    </div>
                </div>

                <div className='max-w-3xs space-y-14 mt-8'>
